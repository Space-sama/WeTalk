...
export default class Search {
    ...
    constructor() {
        ...
        this.overlay = document.querySelector(".search-overlay") // the search icon to open
        this.closeIcon = document.querySelector(".close-live-search") // the x to close
    ...
    renderResultHTML(posts) {
        if (posts.length) {
            ...
            this.resultArea.innerHTML = `<p class="alert alert-danger text-center shadow">Désolé, nous n'avons trouvé aucun résultat pour cette recherche.</p>`
        }
         this.hideLoaderIcon()
         this.showResultArea()
    }
    ...
    openOverlay() {
        ...
        setTimeout(() => this.inputField.focus(), 50 /*mili seconds*/)
    }
    ...
    injectHTML() {
        ...
        <div class="search-overlay-top shadow-sm">
          <div class="container container--narrow">
            ...
            <input type="text" id="live-search-field" class="live-search-field" placeholder="Qu'est-ce qui vous intéresse?">
